...
interface SectionState {
  items: AutoTaggingItem[];
  pendingChanges: Partial<AutoTaggingItem>;
  [key: string]: unknown;
}
...
export default {
  ...
  actionHandlers: {
    ...
    [SAVE_AUTO_TAGGING]: (
      ...
      const pendingChanges = state.settings.autoTaggings
  ...
  reducers: {
    ...
    [CLONE_AUTO_TAGGING]: function (
      ...
      const pendingChanges: Partial<AutoTaggingItem> = { ...item };
