...
interface SectionState {
  ...
  pendingChanges: Partial<ImportListItem>;
  [key: string]: unknown;
}
...
export default {
  ...
  reducers: {
    ...
    [CLONE_IMPORT_LIST]: (
      ...
      const selectedSchema: Partial<SelectedSchema> = { ...item };
      ...
      newState.selectedSchema = selectedSchema as SelectedSchema;

      const pendingChanges: Partial<ImportListItem> = { ...item };
