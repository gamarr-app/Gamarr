...
export const GAME_HISTORY_MARK_AS_FAILED = 'gameHistory/gameHistoryMarkAsFailed';
...
export const actionHandlers = handleThunks({
  ...
  [FETCH_GAME_HISTORY]: function(getState, payload, dispatch) {
  ...
  [GAME_HISTORY_MARK_AS_FAILED]: function(getState, payload, dispatch) {
    const {
      historyId,
      gameId
    } = payload;
