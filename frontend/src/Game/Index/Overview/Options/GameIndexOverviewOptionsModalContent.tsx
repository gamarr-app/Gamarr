...
import { setGameOverviewOption } from 'Store/Actions/gameIndexActions';
...
function GameIndexOverviewOptionsModalContent(
  props: GameIndexOverviewOptionsModalContentProps
) {
  ...
  const onOverviewOptionChange = useCallback(
    ({ name, value }: { name: string; value: unknown }) => {
      dispatch(setGameOverviewOption({ [name]: value }));
    },
    [dispatch]
  );
