...
const gameIndexSelector = createSelector(
  (state: AppState) => state.gameIndex.posterOptions,
  (posterOptions) => {
    return {
      posterOptions,
    };
...
export default function GameIndexPosters(props: GameIndexPostersProps) {
  const {
    scrollerRef,
    items,
    sortKey,
