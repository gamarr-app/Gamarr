...
export interface GameCastPosterProps
  extends Pick<GameCredit, 'personName' | 'images' | 'character'> {
  igdbId: number;
  posterWidth: number;
  posterHeight: number;
...
function GameCastPoster(props: GameCastPosterProps) {
  const {
    igdbId,
    personName,
    character,
        ...
        <Label className={styles.controls}>
          <span className={styles.externalLinks}>
            <Popover
              ...
              body={
                <Link to={`https://www.thegamedb.org/person/${igdbId}`}>
                  <Label
