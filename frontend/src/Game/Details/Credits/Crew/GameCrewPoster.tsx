...
export interface GameCrewPosterProps
  extends Pick<GameCredit, 'personName' | 'images' | 'job'> {
  igdbId: number;
  posterWidth: number;
  posterHeight: number;
...
function GameCrewPoster(props: GameCrewPosterProps) {
  const {
    igdbId,
    personName,
    job,
