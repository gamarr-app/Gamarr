...
import styles from './EditGameCollectionModalContent.css';

export interface EditGameCollectionModalContentProps {
  collectionId: number;
  onModalClose: () => void;
}

function EditGameCollectionModalContent({
  collectionId,
  onModalClose,
  ...
  const {
    ...
    images,
    tags,
  } = useGameCollection(collectionId)!;
  ...
  return (
    <ModalContent onModalClose={onModalClose}>
      <ModalHeader>
        {translate('EditGameCollectionModalHeader', { title })}
      </ModalHeader>
...
export default EditGameCollectionModalContent;
