...
namespace NzbDrone.Common.Test.InstrumentationTests
{
    ...
    public class CleanseLogMessageFixture
    {
        ...
        [TestCase(@"https://rss.omgwtfnzbs.org/rss-search.php?catid=19,20&user=gamarr&api=mySecret&eng=1")]
        ...
        // Plex
        [TestCase(@" http://localhost:32400/library/metadata/12345/refresh?X-Plex-Client-Identifier=1234530f-422f-4aac-b6b3-01233210aaaa&X-Plex-Product=Gamarr&X-Plex-Platform=Windows&X-Plex-Platform-Version=7&X-Plex-Device-Name=Gamarr&X-Plex-Version=3.0.3.833&X-Plex-Token=mySecret")]
        ...
        [TestCase("https://notifiarr.com/notifier.php: api=1234530f-422f-4aac-b6b3-01233210aaaa&gamarr_health_issue_message=Download")]
        [TestCase("/readarr/signalr/messages/negotiate?access_token=1234530f422f4aacb6b301233210aaaa&negotiateVersion=1")]
        [TestCase(@"[Info] MigrationController: *** Migrating Database=gamarr-main;Host=postgres14;Username=mySecret;Password=mySecret;Port=5432;Enlist=False ***")]
        [TestCase(@"[Info] MigrationController: *** Migrating Database=gamarr-main;Host=postgres14;Username=mySecret;Password=mySecret;Port=5432;token=mySecret;Enlist=False&username=mySecret;mypassword=mySecret;mypass=shouldkeep1;test_token=mySecret;password=123%@%_@!#^#@;use_password=mySecret;get_token=shouldkeep2;usetoken=shouldkeep3;passwrd=mySecret;")]
        ...
        // Notifiarr
        [TestCase(@"https://xxx.yyy/api/v1/notification/gamarr/9pr04sg6-0123-3210-imav-eql2tyu8xyui")]
