...
namespace Gamarr.Api.V3.Wanted
{
    ...
    public class MissingController : GameControllerWithSignalR
    {
        public MissingController(IGameService gameService,
        ...
        public PagingResource<GameResource> GetMissingGames([FromQuery] PagingRequestResource paging, bool monitored = true)
        {
            ...
            var resource = pagingSpec.ApplyToPage(_gameService.GamesWithoutFiles, v => MapToResource(v));
