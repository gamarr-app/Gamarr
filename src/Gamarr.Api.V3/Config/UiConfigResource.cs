...
namespace Gamarr.Api.V3.Config
{
    public class UiConfigResource : RestResource
    {
        ...
        // Games
        public GameRuntimeFormatType GameRuntimeFormat { get; set; }
        ...
        public int GameInfoLanguage { get; set; }
    ...
    public static class UiConfigResourceMapper
    {
        public static UiConfigResource ToResource(IConfigFileProvider config, IConfigService model)
        {
            return new UiConfigResource
            {
                ...
                GameRuntimeFormat = model.GameRuntimeFormat,
                ...
                GameInfoLanguage = model.GameInfoLanguage,
