...
namespace NzbDrone.Common.EnvironmentInfo
{
    public class RuntimeInfo : IRuntimeInfo
    {
        ...
        public RuntimeInfo(Logger logger, IHostLifetime hostLifetime = null)
        {
            ...
            // executable name (Gamarr on linux).  On mono this will return the location of
            ...
            if (entry != null)
            {
                ...
                IsWindowsTray = OsInfo.IsWindows && entry.ModuleName == $"{ProcessProvider.GAMARR_PROCESS_NAME}.exe";
            }
        }
        ...
        public bool IsTray
        {
            get
            {
                if (OsInfo.IsWindows)
                {
                    return IsUserInteractive && Process.GetCurrentProcess().ProcessName.Equals(ProcessProvider.GAMARR_PROCESS_NAME, StringComparison.InvariantCultureIgnoreCase);
                }
