...
namespace NzbDrone.Console
{
    public static class ConsoleApp
    {
        ...
        public static void Main(string[] args)
        {
            ...
            catch (GamarrStartupException ex)
            {
            ...
            catch (SocketException ex)
            {
                System.Console.WriteLine("");
                System.Console.WriteLine("");
                Logger.Fatal(ex.Message + " This can happen if another instance of Gamarr is already running another application is using the same port (default: 6767) or the user has insufficient permissions");
