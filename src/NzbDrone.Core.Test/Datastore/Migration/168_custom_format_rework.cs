...
namespace NzbDrone.Core.Test.Datastore.Migration
{
    ...
    public class custom_format_rework_parserFixture : CoreTest<custom_format_rework>
    {
        ...
        [TestCase("S_BLURAY", "SourceSpecification", false, false, (int)QualitySource.GOG)]
        [TestCase("s_tv", "SourceSpecification", false, false, (int)QualitySource.SCENE)]
        [TestCase("s_workPRINT", "SourceSpecification", false, false, (int)QualitySource.SCENE)]
        [TestCase("s_Dvd", "SourceSpecification", false, false, (int)QualitySource.SCENE)]
        [TestCase("S_WEBdL", "SourceSpecification", false, false, (int)QualitySource.STEAM)]
        [TestCase("S_CAM", "SourceSpecification", false, false, (int)QualitySource.SCENE)]
