...
namespace NzbDrone.Core.Test.MediaFiles.GameImport.Aggregation.Aggregators.Augmenters.Language
{
    [TestFixture]
    public class AugmentLanguageFromMediaInfoFixture : CoreTest<AugmentLanguageFromMediaInfo>
    {
        ...
        public void should_return_null_if_media_info_is_null()
        {
            ...
            Subject.AugmentLanguage(localGame, null).Should().Be(null);
        }
        ...
        public void should_return_language_for_single_known_language()
        {
            ...
            var result = Subject.AugmentLanguage(localGame, null);
