...
{
    [TestFixture]
    public class DownloadedGamesCommandServiceFixture : CoreTest<DownloadedGameCommandService>
    {
        ...
        public void should_process_folder_if_downloadclientid_is_not_specified()
        {
            ...
            Subject.Execute(new DownloadedGamesScanCommand() { Path = _downloadFolder });

            Mocker.GetMock<IDownloadedGameImportService>().Verify(c => c.ProcessPath(It.IsAny<string>(), ImportMode.Auto, null, null), Times.Once());
        }
        ...
        public void should_process_file_if_downloadclientid_is_not_specified()
        {
            ...
            Subject.Execute(new DownloadedGamesScanCommand() { Path = _downloadFile });
        ...
        public void should_process_folder_with_downloadclientitem_if_available()
        {
            ...
            Subject.Execute(new DownloadedGamesScanCommand() { Path = _downloadFolder, DownloadClientId = "sab1" });

            Mocker.GetMock<IDownloadedGameImportService>().Verify(c => c.ProcessPath(_downloadFolder, ImportMode.Auto, _trackedDownload.RemoteGame.Game, _trackedDownload.DownloadItem), Times.Once());
        }
        ...
        public void should_process_folder_without_downloadclientitem_if_not_available()
        {
            ...
            Mocker.GetMock<IDownloadedGameImportService>().Verify(c => c.ProcessPath(_downloadFolder, ImportMode.Auto, null, null), Times.Once());
        ...
        public void should_warn_if_neither_folder_or_file_exists()
        {
            ...
            Mocker.GetMock<IDownloadedGameImportService>().Verify(c => c.ProcessPath(It.IsAny<string>(), ImportMode.Auto, null, null), Times.Never());
        ...
        public void should_override_import_mode()
        {
            ...
            Subject.Execute(new DownloadedGamesScanCommand() { Path = _downloadFile, ImportMode = ImportMode.Copy });

            Mocker.GetMock<IDownloadedGameImportService>().Verify(c => c.ProcessPath(It.IsAny<string>(), ImportMode.Copy, null, null), Times.Once());
        }
    }
}
