...
namespace NzbDrone.Core.Test.GameTests.AlternativeTitleServiceTests
{
    ...
    public class AlternativeTitleServiceFixture : CoreTest<AlternativeTitleService>
    {
        ...
        public void Setup()
        {
            var titles = Builder<AlternativeTitle>.CreateListOfSize(3).All().With(t => t.GameMetadataId = 0).Build();
            _title1 = titles[0];
            _title2 = titles[1];
            _title3 = titles[2];
        ...
        {
            Mocker.GetMock<IAlternativeTitleRepository>()
                .Setup(r => r.FindByGameMetadataId(_game.Id))
        ...
        public void should_update_insert_remove_titles()
        {
            ...
            Subject.UpdateTitles(titles, _game);
        ...
        public void should_not_insert_main_title()
        {
            ...
            var game = Builder<GameMetadata>.CreateNew().With(m => m.CleanTitle = _title1.CleanTitle).Build();

            Subject.UpdateTitles(titles, game);
        ...
        public void should_update_game_id()
        {
            ...
            _title1.GameMetadataId.Should().Be(_game.Id);
            _title2.GameMetadataId.Should().Be(_game.Id);
        }
        ...
        public void should_update_with_correct_id()
        {
            ...
            var result = Subject.UpdateTitles(new List<AlternativeTitle> { updateTitle }, _game);
