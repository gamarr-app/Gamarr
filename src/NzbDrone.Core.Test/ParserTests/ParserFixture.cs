...
namespace NzbDrone.Core.Test.ParserTests
{
    ...
    public class ParserFixture : CoreTest
    {
        ...
        [TestCase("Space.Haven-rG", "Space Haven")]
        [TestCase("RoadOut-Unleashed", "RoadOut")]
        [TestCase("Cast.N.Chill.Eastern.Winds-Unleashed", "Cast N. Chill Eastern Winds")]
        [TestCase("Hades.II.MacOS-BiGMAC", "Hades II")]
        [TestCase("Space.Haven.Linux-rG", "Space Haven")]
        [TestCase("Gemini.Rue.v3.7.3.MacOS-rG", "Gemini Rue")]
        [TestCase("The.Long.Dark.v2.52.incl.DLC.MacOS-BiGMAC", "The Long Dark")]
        [TestCase("Iron_Rails_AMIGA-TRSi", "Iron Rails AMIGA")]
