...
namespace NzbDrone.Core.Test.Download.DownloadClientTests.FreeboxDownloadTests
{
    ...
    public class TorrentFreeboxDownloadFixture : DownloadClientFixtureBase<TorrentFreeboxDownload>
    {
        ...
        {
            var game = base.CreateRemoteGame();

            game.Release.DownloadUrl = _downloadURL;
        ...
        public async Task Download_with_DestinationDirectory_should_force_directory()
        {
            ...
            Mocker.GetMock<IFreeboxDownloadProxy>()
                  .Verify(v => v.AddTaskFromUrl(It.IsAny<string>(), $"{_destinationDirectory}/Cyberpunk.2077.v2.1-CODEX".EncodeBase64(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<double?>(), It.IsAny<FreeboxDownloadSettings>()), Times.Once());
        }
        ...
        public async Task Download_with_Category_should_force_directory()
        {
            ...
            Mocker.GetMock<IFreeboxDownloadProxy>()
                  .Verify(v => v.AddTaskFromUrl(It.IsAny<string>(), $"{_defaultDestination}/{_category}/Cyberpunk.2077.v2.1-CODEX".EncodeBase64(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<double?>(), It.IsAny<FreeboxDownloadSettings>()), Times.Once());
        }
        ...
        public async Task Download_without_DestinationDirectory_and_Category_should_use_default()
        {
            ...
            Mocker.GetMock<IFreeboxDownloadProxy>()
                  .Verify(v => v.AddTaskFromUrl(It.IsAny<string>(), $"{_defaultDestination}/Cyberpunk.2077.v2.1-CODEX".EncodeBase64(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<double?>(), It.IsAny<FreeboxDownloadSettings>()), Times.Once());
        }
        ...
        public async Task Download_should_queue_torrent_first_as_expected(int ageDay, int olderPriority, int recentPriority, bool toBeQueuedFirstFlag)
        {
            ...
            remoteGame.Game.GameMetadata.Value.PhysicalRelease = DateTime.UtcNow.AddDays(-ageDay);
        ...
        public async Task Download_should_define_seed_ratio_as_expected(double? providerSeedRatio, double? expectedSeedRatio)
        {
            ...
            remoteGame.SeedConfiguration = new TorrentSeedConfiguration();
            remoteGame.SeedConfiguration.Ratio = providerSeedRatio;
