...
namespace NzbDrone.Core.Notifications.Emby
{
    ...
    public class MediaBrowserSettings : NotificationSettingsBase<MediaBrowserSettings>
    {
        ...
        [FieldDefinition(7, Label = "NotificationsSettingsUpdateMapPathsFrom", HelpText = "NotificationsSettingsUpdateMapPathsFromGameHelpText", Type = FieldType.Textbox, Advanced = true)]
        [FieldToken(TokenField.HelpText, "NotificationsSettingsUpdateMapPathsFrom", "serviceName", "Emby/Jellyfin")]
        public string MapFrom { get; set; }

        [FieldDefinition(8, Label = "NotificationsSettingsUpdateMapPathsTo", HelpText = "NotificationsSettingsUpdateMapPathsToGameHelpText", Type = FieldType.Textbox, Advanced = true)]
