    ...
    public class JoinProxy : IJoinProxy
    {
        ...
        private void SendNotification(string title, string message, HttpMethod method, JoinSettings settings)
        {
            ...
            var request = requestBuilder.AddQueryParam("apikey", settings.ApiKey)
                          ...
                          .AddQueryParam("icon", "https://cdn.rawgit.com/Gamarr/Gamarr/develop/Logo/256.png") // Use the Gamarr logo.
                          .AddQueryParam("smallicon", "https://cdn.rawgit.com/Gamarr/Gamarr/develop/Logo/96-Outline-White.png") // 96x96px with outline at 88x88px on a transparent background.
