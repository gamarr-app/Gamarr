...
namespace NzbDrone.Core.HealthCheck
{
    public class HealthCheck : ModelBase
    {
        ...
        {
            return new HttpUri("https://github.com/gamarr-app/Gamarr/wiki/system#") + new HttpUri(fragment);
        }
    }
    ...
    public enum HealthCheckReason
    {
        ...
        RemotePathMappingDownloadPermissionsGame,
        ...
        RemotePathMappingImportGameFailed,
