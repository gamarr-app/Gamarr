...
namespace NzbDrone.Core.Validation
{
    public static class RuleBuilderExtensions
    {
        ...
        public static IRuleBuilderOptions<T, string> ValidUrlBase<T>(this IRuleBuilder<T, string> ruleBuilder, string example = "/gamarr")
        {
        ...
        public static IRuleBuilderOptions<T, string> ContainsGamarr<T>(this IRuleBuilder<T, string> ruleBuilder)
        {
            ruleBuilder.SetValidator(new NotEmptyValidator(null));
            return ruleBuilder.SetValidator(new RegularExpressionValidator("gamarr", RegexOptions.IgnoreCase)).WithMessage("Must contain Gamarr");
        }
