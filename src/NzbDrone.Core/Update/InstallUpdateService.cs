...
namespace NzbDrone.Core.Update
{
    public class InstallUpdateService : IExecute<ApplicationCheckUpdateCommand>, IExecute<ApplicationUpdateCommand>, IHandle<ApplicationStartingEvent>
    {
        ...
        private bool InstallUpdate(UpdatePackage updatePackage)
        {
            ...
            {
                _logger.Warn("Temporary location '{0}' has less than 1 GB free space, Gamarr may not be able to update itself.", tempFolder);
            }
            ...
            _logger.ProgressInfo("Gamarr will restart shortly.");
        ...
        private void InstallUpdateWithScript(string updateSandboxFolder)
        {
            ...
            _logger.Info("Removing Gamarr.Update");
        ...
        private void EnsureAppDataSafety()
        {
            ...
            {
                throw new UpdateFailedException("Your Gamarr configuration '{0}' is being stored in application folder '{1}' which will cause data lost during the upgrade. Please remove any symlinks or redirects before trying again.", _appFolderInfo.AppDataFolder, _appFolderInfo.StartUpFolder);
            }
        }
        ...
        public void Execute(ApplicationUpdateCommand message)
        {
            ...
            if (latestAvailable != null)
            {
                try
                {
                    ...
                    _logger.ProgressDebug("Restarting Gamarr to apply updates");
                }
