...
{
    public class DownloadedGameCommandService : IExecute<DownloadedGamesScanCommand>
    {
        ...
        public DownloadedGameCommandService(IDownloadedGameImportService downloadedGameImportService,
        ...
        private List<ImportResult> ProcessPath(DownloadedGamesScanCommand message)
        {
            ...
            if (message.DownloadClientId.IsNotNullOrWhiteSpace())
            {
                ...
                if (trackedDownload != null)
                {
                    ...
                    var importResults = _downloadedGameImportService.ProcessPath(message.Path, message.ImportMode, trackedDownload.RemoteGame.Game, trackedDownload.DownloadItem);
            ...
            return _downloadedGameImportService.ProcessPath(message.Path, message.ImportMode);
        }

        public void Execute(DownloadedGamesScanCommand message)
        {
