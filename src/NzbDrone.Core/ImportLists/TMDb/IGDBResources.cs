...
namespace NzbDrone.Core.ImportLists.TMDb
{
    public class GameSearchResource
    {
        ...
        public GameResultResource[] Results { get; set; }
    ...
    public class CreditsResultResource : GameResultResource
    {
    ...
    public class CollectionResponseResource
    {
        ...
        [JsonProperty("backdrop_path")]
        public string BackdropPath { get; set; }
        public GameResultResource[] Parts { get; set; }
    }
    ...
    public class ListItemResource : GameResultResource
    {
