...
namespace NzbDrone.Core.Indexers.Nyaa
{
    ...
    public class NyaaSettings : PropertywiseEquatable<NyaaSettings>, ITorrentIndexerSettings
    {
        ...
        [FieldDefinition(7, Type = FieldType.Select, SelectOptions = typeof(IndexerFlags), Label = "IndexerSettingsRequiredFlags", HelpText = "IndexerSettingsRequiredFlagsHelpText", HelpLink = "https://github.com/gamarr-app/Gamarr/wiki/settings#indexer-flags", Advanced = true)]
