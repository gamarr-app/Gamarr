...
PackageFiles()
{
    ...
    cp -r $outputFolder/Gamarr.Update/$framework/$runtime/publish $folder/Gamarr.Update
...
PackageLinux()
{
    ...
    local folder=$artifactsFolder/$runtime/$framework/Gamarr
    ...
    echo "Removing Gamarr.Windows"
    rm $folder/Gamarr.Windows.*

    echo "Adding Gamarr.Mono to UpdatePackage"
    cp $folder/Gamarr.Mono.* $folder/Gamarr.Update
    if [ "$framework" = "net8.0" ]; then
        cp $folder/Mono.Posix.NETStandard.* $folder/Gamarr.Update
        cp $folder/libMonoPosixHelper.* $folder/Gamarr.Update
    fi
...
PackageMacOSApp()
{
    ...
    rm -rf $folder
    mkdir -p $folder
    cp -r distribution/osx/Gamarr.app $folder
    mkdir -p $folder/Gamarr.app/Contents/MacOS

    echo "Copying Binaries"
    cp -r $artifactsFolder/$runtime/$framework/Gamarr/* $folder/Gamarr.app/Contents/MacOS

    echo "Removing Update Folder"
    rm -r $folder/Gamarr.app/Contents/MacOS/Gamarr.Update
...
PackageWindows()
{
    ...
    echo "Removing Gamarr.Mono"
    rm -f $folder/Gamarr.Mono.*
    rm -f $folder/Mono.Posix.NETStandard.*
    rm -f $folder/libMonoPosixHelper.*

    echo "Adding Gamarr.Windows to UpdatePackage"
    cp $folder/Gamarr.Windows.* $folder/Gamarr.Update
...
BuildInstaller()
{
    ...
    ./_inno/ISCC.exe distribution/windows/setup/gamarr.iss "//DFramework=$framework" "//DRuntime=$runtime"
}
